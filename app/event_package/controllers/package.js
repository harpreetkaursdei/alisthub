...
console.log( s_clix_array );
        ...
        req.body.online_sales_open_date_time = moment(req.body.online_sales_open_date_time).format('YYYY-MM-DD HH:mm:ss');
        req.body.online_sales_close_date_time = moment(req.body.online_sales_close_date_time).format('YYYY-MM-DD HH:mm:ss');
                ...
                if (query != "") {
                    connection.query(query, function(err7, results) {
                        ...
                        if (results) {
                            ...
                            var query_delete_event = "DELETE FROM package_event_map WHERE package_id = " + package_id;
                            connection.query(query_delete_event, function(delEventError, delEventResults) {
                                if (delEventError) {
                                    res.json({ error: delEventError, code: 101 });
                                }
                            });
